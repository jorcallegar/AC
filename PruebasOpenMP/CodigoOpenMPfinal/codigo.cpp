    ...
    gettimeofday(&tiempo0, NULL);
        ...
        //if(z == 0)
          //  cout << "Número de hilos: " << omp_get_num_threads() << endl;
                ...
                {
                                        for(j= -m/2; j <= m/2; j++)
                                {//cout << "numero" << omp_get_num_threads() <<endl;
                                        //He anyadido el B[z][x][y] en el sumatorio, pues al final todo es una operaciï¿½n de lo va sumando
